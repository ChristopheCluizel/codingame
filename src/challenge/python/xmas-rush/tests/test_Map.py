...
def test_simulate_move():
    ...
    simulated_map, item_position, my_player_position, items = map.simulate_move(Position(0, 0), tile, 0, "RIGHT", [])
    ...
    simulated_map, item_position, my_player_position, items = map.simulate_move(Position(0, 0), tile, 2, "LEFT", [])
    ...
    simulated_map, item_position, my_player_position, items = map.simulate_move(Position(0, 0), tile, 1, "UP", [])
    ...
    simulated_map, item_position, my_player_position, items = map.simulate_move(Position(0, 0), tile, 2, "DOWN", [])
    assert [str(tile) for tile in simulated_map.tiles[0]] == ["0110", "0101", "0111", "0011"]
